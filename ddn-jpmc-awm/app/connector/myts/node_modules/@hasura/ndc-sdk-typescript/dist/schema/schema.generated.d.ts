...
export type TypeRepresentation = {
    ...
    /** @deprecated since NDC Spec v0.1.2 - use sized numeric types instead */ type: "number";
} | {
    /** @deprecated since NDC Spec v0.1.2 - use sized numeric types instead */ type: "integer";
} | {
    type: "int8";
} | {
    type: "int16";
